	...
	$tpclist='';
				...
				elseif($post_type=="tpmfcarousel"){
						...
						if($post_styles=="style5"){
							...
							#tpcarouselitems-'.$townlrndnsss.' .owl-controls .owl-buttons .owl-prev {float:left; background: url(/wp-content/uploads/2017/04/10.png) no-repeat;}
							#tpcarouselitems-'.$townlrndnsss.' .owl-controls .owl-buttons .owl-next {float:right; background: url(/wp-content/uploads/2017/04/10.1.png) no-repeat;}
							...
							#tpcarouselitems6-'.$townlrndnsss.' .owl-controls .owl-buttons .owl-prev {float:left; background: url(/wp-content/uploads/2017/04/10.1.png) no-repeat; text-indent:-3000px }
							#tpcarouselitems6-'.$townlrndnsss.' .owl-controls .owl-buttons .owl-next {float:right; background: url(/wp-content/uploads/2017/04/10.png) no-repeat; text-indent:-3000px }
